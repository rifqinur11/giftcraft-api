...
CREATE TABLE "Order" (
    ...
    "totalShipping" DOUBLE PRECISION DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Shipment" ADD CONSTRAINT "Shipment_expeditionId_fkey" FOREIGN KEY ("expeditionId") REFERENCES "Expedition"("id") ON DELETE CASCADE ON UPDATE CASCADE;
